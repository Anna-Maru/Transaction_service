...
def sample_transactions_list():
    """Пример транзакций для тестов инвесткопилки."""
    return [
        ...
        {"Дата операции": "2025-06-01", "Сумма операции": 540},  # другой месяц
    ]


@pytest.mark.parametrize("limit,expected", [
    (50,  (1750 - 1712) + (850 - 803) + (1000 - 1000)),  # = 38 + 47 + 0 = 85
    (100, (1800 - 1712) + (900 - 803) + (1100 - 1000)),  # = 88 + 97 + 100 = 285
])
def test_investment_bank_valid(sample_transactions_list, limit, expected):
    """Проверяем правильность расчёта округлений."""
